...
OMP_NUM_THREADS=1 torchrun --standalone --nnodes=1 --nproc_per_node=4  finetune_hf.py data/ /home/dxd/bishe/chatglm3-6b-32k  configs/lora.yaml  --deepspeed ds_zero_2.json
```
